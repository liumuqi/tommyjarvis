...
public class ThreadPoolExtend extends ThreadPoolExecutor {
    ...
    public static ExecutorService newFixedThreadPool(int nThreads, String poolName) {
        return new ThreadPoolExtend(nThreads, nThreads, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(), poolName);
    }
    ...
    public static ExecutorService newCachedThreadPool(String poolName) {
        return new ThreadPoolExtend(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), poolName);
    }
